...
%ni obstáculos en un canal con reflexiones.
...
messageTitle = sprintf('BER%dX%d ideal refl',nUsers,nAntennas);
title = 'ber_sim_3X4_ideal_refl';
    ...
    for k = 1:1:length(snr)    
        ...
        for iteration = 1:1:iterationsNum
           ...
           parfor j = 1:1:totalNBits/nBitsIteration
                ...
                signalEstimations = signalEstimationWithNoise(b,hrhat,nAntennas,nUsers,snr_iteration);
