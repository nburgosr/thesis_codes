...
%ni obstáculos en un canal donde hay reflexiones.
...
spaceSize = 3;                                                              % Tamaño del espacio de simulacion
...
snr = 6:1:10;                                                               % Valores de SNR en simulacion en DB
...
title = sprintf("ber_sim_%dX%d_ideal_obs",nUsers,nAntennas);
