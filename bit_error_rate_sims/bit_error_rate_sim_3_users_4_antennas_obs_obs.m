...
imports
%Simulación para 3 usuario y 4 antenas, estimación de canal con reflexiones
%y obstáculos en un canal con reflexiones y obstáculos.
...
messageTitle = sprintf('BER%dX%d obs obs',nUsers,nAntennas);
title = 'ber_sim_3X4_obs_obs';
    ...
    for k = 1:1:length(snr)    
        ...
        for iteration = 1:1:iterationsNum
            ...
            parfor j = 1:1:totalNBits/nBitsIteration
                ...
                %% DIDO
                b = DIDO(nUsers,nAntennas,ppassBand,signalLength,Hrohat); 

                %% Calculo de senales estimadas o recibidas
                signalEstimations = signalEstimationWithNoise(b,hrohat,nAntennas,nUsers,snr_iteration);
