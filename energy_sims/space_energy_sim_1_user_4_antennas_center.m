...
for i=1:1:4
    ...
    title = sprintf("corr_sim_%d_user_%d_antennas_center",nUsers,nAntennas);
    ...
    if i == 1
        ...
        %User 1
        tic
        correlations1IdealIdeal = spaceCorrelation(nAntennas,signalLength,b,axy,spaceSize,deltaSpace,FcReal,oversamplingFactor);
        toc
        tic
        correlations1IdealRefl = spaceCorrelationConsideringReflections(nAntennas,signalLength,b,axy,spaceSize,deltaSpace,FcReal,oversamplingFactor);
        toc
        tic
        correlations1IdealObs = spaceCorrelationConsideringReflectionsAndObstacles(nAntennas,signalLength,b,axy,spaceSize,deltaSpace,FcReal,oversamplingFactor,obstacles);
        toc
        tic
        correlations1ReflRefl = spaceCorrelationConsideringReflections(nAntennas,signalLength,br,axy,spaceSize,deltaSpace,FcReal,oversamplingFactor);
        toc
        tic
        correlations1ReflObs = spaceCorrelationConsideringReflectionsAndObstacles(nAntennas,signalLength,br,axy,spaceSize,deltaSpace,FcReal,oversamplingFactor,obstacles);
        toc
        tic
        correlations1ObsObs = spaceCorrelationConsideringReflectionsAndObstacles(nAntennas,signalLength,bro,axy,spaceSize,deltaSpace,FcReal,oversamplingFactor,obstacles);
        toc
    ...
    save(title)
    sendNotification('ENE1X4','Success','correo@gmail.com');

    toc
end
 
catch
    sendNotification('ENE1X4','Error','correo@gmail.com');
end

sendNotification('ENE1X4','Finish','correo@gmail.com');
