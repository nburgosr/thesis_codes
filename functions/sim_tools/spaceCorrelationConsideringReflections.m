function [orderedCorrelations,correlationsStruct] = spaceCorrelationConsideringReflections(nAntennas,FcSim,FsSim,userSignal,signalLength,b,axy,spaceSize,deltaSpace,Fc,oversamplingFactor)
