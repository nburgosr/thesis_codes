function [orderedEnergy] = spaceEnergyConsideringReflectionsAndObstacles(nAntennas,signalLength,b,axy,spaceSize,deltaSpace,Fc,oversamplingFactor,obstacle)
   ...
   for j = 1:nWidth
        try
            ...
            if isInside(axy,mapPosition)
                ...
                for k = 1:1:nAntennas
                    h(k,:) = hWithReflection(mapPosition,axy(k,:),spaceSize,Fc,signalLength,oversamplingFactor,obstacle);
                end
