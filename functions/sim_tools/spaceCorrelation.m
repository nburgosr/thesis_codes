function [orderedCorrelations,correlationsStruct] = spaceCorrelation(nAntennas,FcSim,FsSim,userSignal,signalLength,b,axy,spaceSize,deltaSpace,Fc,oversamplingFactor,varargin)
